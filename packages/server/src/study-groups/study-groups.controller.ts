...
export class StudyGroupsController {
  ...
  create(@Body() body: CreateStudyGroupDto, @Req() req: AuthenticatedRequest) {
  ...
  upvoteQuestion(@Param('questionId') questionId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  deleteAnswer(@Param('answerId') answerId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  upvoteAnswer(@Param('answerId') answerId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  getPost(@Param('postId') postId: string, @Req() req: AuthenticatedRequest) {
  ...
  deletePost(@Param('postId') postId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  likePost(@Param('postId') postId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  listReactions(@Param('postId') postId: string, @Req() req: AuthenticatedRequest) {
  ...
  listComments(@Param('postId') postId: string, @Req() req: AuthenticatedRequest) {
  ...
  deleteEvent(@Param('eventId') eventId: string, @Req() req: AuthenticatedRequest) {
    if (!req.user?.id) throw new UnauthorizedException('로그인이 필요합니다')
  ...
  stats(@Param('id') id: string, @Req() req: AuthenticatedRequest) {
