...
describe('ResumesController', () => {
  ...
  describe('setVisibility (PATCH /resumes/:id/visibility)', () => {
    ...
    it('관리자 → 다른 사용자 이력서 공개 설정 가능', async () => {
      ...
      expect(mockResumesService.setVisibility).toHaveBeenCalledWith(
        'r1',
        'private',
        'admin1',
        'admin',
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.setVisibility('r1', 'public', { user: null })).toThrow(
        UnauthorizedException,
      );
    });
  });
  ...
  describe('remove (DELETE /resumes/:id)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.remove('r1', { user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('addBookmark (POST /resumes/:id/bookmark)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.addBookmark('r1', { user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('removeBookmark (DELETE /resumes/:id/bookmark)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.removeBookmark('r1', { user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('duplicate (POST /resumes/:id/duplicate)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.duplicate('r1', { user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('exportText (GET /resumes/:id/export/text)', () => {
    ...
    it('존재하지 않는 이력서 → NotFoundException 전달', async () => {
      mockExportService.exportAsText.mockRejectedValue(
  ...
  describe('transferOwnership (PATCH /resumes/:id/transfer)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.transferOwnership('r1', 'u2', { user: null })).toThrow(
        UnauthorizedException,
      );
    });
  });
  ...
  describe('getBookmarks (GET /resumes/bookmarks/list)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.getBookmarks({ user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('analytics (GET /resumes/dashboard/analytics)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.analytics({ user: null })).toThrow(UnauthorizedException);
    });
  });
  ...
  describe('updateSlug (PATCH /resumes/:id/slug)', () => {
    ...
    it('비로그인 → UnauthorizedException', () => {
      expect(() => controller.updateSlug('r1', 'slug', { user: null })).toThrow(
        UnauthorizedException,
      );
    });
  });
