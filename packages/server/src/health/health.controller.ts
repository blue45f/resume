...
export class HealthController {
  ...
  async publicStats() {
    const [users, resumes, views, templates, publicResumes, communityPosts, comments, jobs] =
      await Promise.all([
        this.prisma.user.count(),
        this.prisma.resume.count(),
  ...
  async sitemapXml(@Res() res: Response) {
    ...
    const staticUrls: Array<{
      ...
      { loc: `${BASE}/coaches`, priority: '0.8', changefreq: 'weekly' },
      { loc: `${BASE}/study-groups`, priority: '0.8', changefreq: 'daily' },
      { loc: `${BASE}/community`, priority: '0.8', changefreq: 'daily' },
      { loc: `${BASE}/interview-prep`, priority: '0.7', changefreq: 'weekly' },
      { loc: `${BASE}/mock-interview`, priority: '0.7', changefreq: 'weekly' },
