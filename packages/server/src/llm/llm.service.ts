...
Output only the translated text. No explanations.`,
      specificity: `당신은 이력서 컨설턴트입니다. 주어진 문장의 추상적·모호한 표현을 구체적으로 바꿔주세요.
- "다양한 업무", "여러 프로젝트" 같은 모호한 표현을 실제 기술·도구·역할·상황으로 구체화
- 예: "다양한 개발 업무 수행" → "React·TypeScript 기반 결제 모듈 3종 설계 및 운영"
- 원래 의미는 유지하되 고유명사와 구체 맥락을 더함
개선된 문장만 출력하세요. 설명 없이 결과만 출력하세요.`,
      'strong-verb': `당신은 이력서 작성 전문가입니다. 주어진 문장의 약한 동사를 강한 액션 동사로 바꿔주세요.
- "담당했다", "참여했다", "수행했다" 같은 수동적 표현을 "주도", "구현", "달성", "최적화" 등 주도적 동사로 교체
- 성과와 주체성이 드러나도록 문장 구조 조정
- 원래 의미는 유지
개선된 문장만 출력하세요. 설명 없이 결과만 출력하세요.`,
      'positive-tone': `당신은 자기소개서 코치입니다. 주어진 문장의 부정적·자기비하적 표현을 긍정적·성장 지향적으로 바꿔주세요.
- "부족하지만", "잘 못하지만" 같은 자기비하를 강점·학습 의지로 재구성
- 약점 언급 시 개선 노력과 성장으로 마무리
- 과장 없이 자신감 있는 톤 유지
개선된 문장만 출력하세요. 설명 없이 결과만 출력하세요.`,
    }
