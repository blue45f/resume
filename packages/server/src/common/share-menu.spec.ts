...
function buildKakaoUrl(url: string): string {
...
function buildLineUrl(url: string): string {
...
function buildEmailUrl(title: string, description: string, url: string): string {
...
describe('ShareMenu SNS 공유 URL 생성', () => {
  ...
  describe('Facebook', () => {
    it('Facebook sharer URL 형식', () => {
      ...
      expect(result).toBe(
        `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(sampleUrl)}`,
      );
    });
  ...
  describe('LINE', () => {
    it('LINE 소셜 플러그인 URL 형식', () => {
      ...
      expect(result).toBe(
        `https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(sampleUrl)}`,
      );
    });
  ...
  describe('Twitter', () => {
    it('Twitter intent URL 형식', () => {
      ...
      expect(result).toBe(
        `https://twitter.com/intent/tweet?text=${encodeURIComponent(sampleTitle)}&url=${encodeURIComponent(sampleUrl)}`,
      );
    });
  ...
  describe('LinkedIn', () => {
    it('LinkedIn sharing URL 형식', () => {
      ...
      expect(result).toBe(
        `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(sampleUrl)}`,
      );
    });
