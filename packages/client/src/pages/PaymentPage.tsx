        ...
        <div className="stagger-children grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <button
              ...
              className="w-full py-3.5 bg-sky-700 text-white font-medium rounded-xl hover:bg-sky-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg shadow-blue-600/20 hover:shadow-blue-600/30"
            >
