...
export default function NotificationBell() {
  ...
  const getNotifIcon = (type: string) => {
    const icons: Record<string, { icon: string; color: string }> = {
      ...
      coaching_review_received: { icon: '⭐', color: 'bg-yellow-100 dark:bg-yellow-900/30' },
      job_application_received: { icon: '📥', color: 'bg-blue-100 dark:bg-blue-900/30' },
      job_application_stage: { icon: '📋', color: 'bg-sky-100 dark:bg-sky-900/30' },
      job_search_match: { icon: '🔖', color: 'bg-emerald-100 dark:bg-emerald-900/30' },
      subscription_activated: { icon: '🎉', color: 'bg-blue-100 dark:bg-blue-900/30' },
      subscription_expired: { icon: '⏳', color: 'bg-amber-100 dark:bg-amber-900/30' },
