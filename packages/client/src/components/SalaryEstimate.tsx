          ...
          {activeTab === 'calculator' && (
            <div className="space-y-3">
              ...
              <div className="stagger-children grid grid-cols-2 gap-2">
                <div>
                  <label
                    htmlFor="salaryestimate-field-1"
                    className="text-[10px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"
                  >
                    직종
                  </label>
                  <select
                    id="salaryestimate-field-1"
                    value={jobCategory}
                ...
                <div>
                  <label
                    htmlFor="salaryestimate-field-2"
                    className="text-[10px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"
                  >
                    경력년수
                  </label>
                  <input
                    id="salaryestimate-field-2"
                    type="range"
                    min={0}
                    max={20}
                ...
                <div>
                  <label
                    htmlFor="salaryestimate-field-3"
                    className="text-[10px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"
                  >
                    지역
                  </label>
                  <select
                    id="salaryestimate-field-3"
                    value={region}
                ...
                <div>
                  <label
                    htmlFor="salaryestimate-field-4"
                    className="text-[10px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"
                  >
                    기업규모
                  </label>
                  <select
                    id="salaryestimate-field-4"
                    value={companySize}
