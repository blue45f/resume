  ...
  return (
    ...
    >
      ...
      <div className="aspect-[3/4] relative overflow-hidden">
        ...
        {/* Accent bar */}
        <div className="h-[3px]" style={{ backgroundColor: p?.accentBar || '#3b82f6' }} />

        {/* Body area */}
        <div
          className="px-3 pt-2.5 pb-3 space-y-2.5"
      ...
      <div className="px-3 py-2.5 border-t border-slate-100 dark:border-slate-700">
        ...
        <div className="flex items-center gap-1 mt-1.5">
          {p && (
            <>
              <div
                className="w-3 h-3 rounded-full border border-slate-200 dark:border-slate-600 shrink-0"
                style={{ background: isGradient ? p.accentBar : p.headerBg }}
                title="헤더"
              />
              <div
                className="w-3 h-3 rounded-full border border-slate-200 dark:border-slate-600 shrink-0"
