      ...
      <RadixDialog.Portal>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-2 items-center justify-center">
                ...
                />
                <label
                  className={`px-4 py-1.5 text-white text-sm font-medium rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 transition-colors ${uploading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 cursor-pointer'}`}
                >
                  {uploading ? (
          ...
          <div className="px-4 sm:px-6 py-3 border-t border-neutral-200 dark:border-neutral-700">
            <RadixDialog.Close asChild>
              <button className="w-full px-4 py-2.5 text-sm text-neutral-700 dark:text-neutral-300 bg-neutral-100 dark:bg-neutral-700 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                닫기
              </button>
            </RadixDialog.Close>
          </div>
