...
export default function ExportPanel({ resumeId, resumeTitle, onPrint }: Props) {
      ...
      icon: (
        <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={1.5}
            d="M9 13h2m-2 3h4m2-9V3l5 5h-4a1 1 0 01-1-1z"
          />
        </svg>
      ),
      ...
      icon: (
        ...
        >
          <path
            ...
            d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"
          />
          <text x="8" y="17" fontSize="7" fontWeight="bold" fill="currentColor" stroke="none">
            W
          </text>
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <path
            d="M7 15V9l2.5 3L12 9v6m3-6v4l2-2 2 2V9"
            strokeWidth={1.5}
            strokeLinecap="round"
            strokeLinejoin="round"
          />
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="px-2.5 sm:px-3 py-2 text-slate-600 bg-slate-100 text-xs sm:text-sm font-medium rounded-lg hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 flex items-center gap-2"
      >
