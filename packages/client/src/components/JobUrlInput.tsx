...
const PLACEHOLDER =
  'https://www.wanted.co.kr/wd/123456 또는 https://www.jobkorea.co.kr/Recruit/...';
        ...
        parsed.source === 'json-ld'
          ...
          : parsed.source === 'llm'
            ...
            : parsed.source === 'partial'
              ? '부분 추출 — 빈 항목 직접 보완 필요'
              : '메타 데이터';
      toast(`공고 정보를 가져왔습니다 (${sourceLabel})`, 'success');
    } catch (err) {
      toast(err instanceof Error ? err.message : '공고를 가져오지 못했습니다', 'error');
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      ...
      <div className="mt-1.5 flex items-center justify-between gap-2 flex-wrap">
        <p className="text-[11px] text-blue-700/80 dark:text-blue-400/80 leading-relaxed">
          {hint || '원티드 / 잡코리아 / 사람인 / 점핏 / 프로그래머스 등 한국 채용 사이트 지원'}
        </p>
        {detectedSite && (
