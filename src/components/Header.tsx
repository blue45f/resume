...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`no-print sticky top-0 z-50 border-b header-glass ${scrolled ? 'header-scrolled header-scrolled-enhanced' : ''}`}
      >
        <a
          href="#main-content"
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            >
                ...
                <>
                  ...
                  <div className="relative group">
                    ...
                    <div
                      role="menu"
                      aria-label={t('common.more')}
                      className="absolute left-0 top-full mt-1 w-44 glass-dropdown rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible transition-all duration-200 z-50 py-1"
                    >
                      <p
              ...
              >
                ...
                <kbd className="hidden xl:inline-flex badge-xs badge-neutral font-mono">⌘K</kbd>
              </button>
              {isRecruiter ? (
                <Link
                  to="/jobs/new"
                ...
                <div className="relative">
                  ...
                  {profileMenuOpen && (
                    ...
                    >
                      ...
                      <div
                        className="border-t border-slate-100 dark:border-slate-700 my-1"
                        role="separator"
                      />
                      <Link
                        to="/social/follows"
          ...
          {menuOpen && (
            ...
            >
              ...
              {isRecruiter ? (
                ...
                /* ── 구직자 모바일 메뉴 ── */
                <>
                  <p className="px-3 py-1 text-xs font-medium text-green-500 dark:text-green-400">
                    이력서 관리
                  </p>
                  <Link
                    to="/"
              ...
              <div className="flex items-center gap-2 px-3 py-2">
                ...
                <button
                  onClick={cycleTheme}
                  className="px-3 py-2 text-sm border border-slate-200 dark:border-slate-600 rounded-lg text-slate-600 dark:text-slate-300"
                >
