...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 shadow-lg animate-fade-in-up no-print">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
        <p className="text-sm text-slate-600 dark:text-slate-300 flex-1">
          이력서공방은 로그인 및 서비스 개선을 위해 쿠키를 사용합니다.
          계속 사용하면 <a href="/terms" className="text-blue-600 dark:text-blue-400 underline">이용약관</a>에 동의하는 것으로 간주합니다.
        </p>
        <button
