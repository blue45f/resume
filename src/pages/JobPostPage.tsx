...
export default function JobPostPage() {
  ...
  const onSubmit = async (values: JobPostFormValues) => {
    try {
      const salary = values.salaryText || `${values.salaryMin.toLocaleString()}~${values.salaryMax.toLocaleString()}만원`;
        ...
        {preview ? (
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-5 animate-fade-in">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button onClick={handleSubmit(onSubmit)} disabled={isSubmitting} className="flex-1 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-colors">
          ...
          /* Edit mode */
          <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input {...register('position')} className={inputClass} placeholder="예: 프론트엔드 개발자" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input {...register('location')} className={inputClass} placeholder="예: 서울시 강남구" />
              ...
              <div>
                ...
                <input {...register('salaryText')} className={inputClass} placeholder="비워두면 슬라이더 값 사용" />
                ...
                <div className="flex-1 space-y-1">
                  <input
                    ...
                    onChange={e => {
                      ...
                      setValue('salaryMin', Math.min(v, form.salaryMax - SALARY_STEP), { shouldValidate: true, shouldDirty: true });
                    }}
                  ...
                  <input
                    ...
                    onChange={e => {
                      const v = Number(e.target.value);
                      setValue('salaryMax', Math.max(v, form.salaryMin + SALARY_STEP), { shouldValidate: true, shouldDirty: true });
                    }}
                    className="w-full accent-blue-600"
                  />
                </div>
            ...
            <div>
              ...
              <textarea {...register('description')} rows={6} className={inputClass + ' resize-none font-mono text-xs'} placeholder="## 업무 내용\n- 주요 업무 1\n- 주요 업무 2\n\n## 팀 소개\n우리 팀은..." />
            ...
            <div>
              ...
              <textarea {...register('requirements')} rows={4} className={inputClass + ' resize-none font-mono text-xs'} placeholder="## 필수\n- 3년 이상 경력\n\n## 우대\n- 관련 자격증" />
            ...
            <div>
              ...
              <textarea {...register('benefits')} rows={3} className={inputClass + ' resize-none font-mono text-xs'} placeholder="- 자유로운 연차 사용\n- 교육비 지원\n- 유연근무제" />
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button type="submit" disabled={isSubmitting} className="flex-1 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-colors">
                {isSubmitting ? '등록 중...' : '채용 공고 등록'}
              </button>
            </div>
          </form>
