    ...
    <>
      ...
      <main id="main-content" className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제1조 (목적)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제2조 (서비스 내용)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제3조 (회원가입 및 계정)</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제4조 (개인정보 처리)</h2>
            <ul className="text-sm text-slate-600 dark:text-slate-400 mt-3 space-y-1 list-disc list-inside">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제5조 (이력서 공개 설정)</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제6조 (AI 서비스 이용)</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제7조 (서비스 제한)</h2>
            <ul className="text-sm text-slate-600 dark:text-slate-400 mt-3 space-y-1 list-disc list-inside">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제8조 (면책사항)</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-2">제9조 (약관 변경)</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
