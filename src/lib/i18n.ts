...
const ko: TranslationKeys = {
  ...
  'home.welcomeDesc': 'AI가 도와주는 이력서 작성. 10가지 테마로 미리보기하고, ATS 호환성을 검사하고, 다양한 양식으로 변환하세요.',
...
const en: TranslationKeys = {
  ...
  'home.welcomeDesc': 'AI-powered resume writing. Preview with 10 themes, check ATS compatibility, and convert to various formats.',
...
const ja: TranslationKeys = {
  ...
  'home.welcomeDesc': 'AIが履歴書作成をサポート。10種類のテーマでプレビュー、ATS互換性チェック、多様な形式に変換。',
