...
export const db = {
  resumes: [
    {
      ...
      awards: [
        { id: id(), name: '사내 해커톤 대상', issuer: '테크스타트업', awardDate: '2023-12-01', description: 'AI 기반 이력서 자동화 프로젝트' },
      ],
      activities: [
        { id: id(), name: 'OSS 컨트리뷰터', organization: 'NestJS', role: 'Contributor', startDate: '2023-01-01', endDate: '2024-06-30', description: 'NestJS 한국어 문서 번역' },
      ],
      tags: [] as Tag[],
    },
  ...
  templates: [
    { id: id(), name: '표준 이력서', description: '한국어 표준 이력서 양식', category: 'general', prompt: '', layout: '{}', isDefault: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: id(), name: '개발자 이력서', description: '기술 스택 강조 양식', category: 'developer', prompt: '', layout: '{}', isDefault: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  ] as (Template & { createdAt: string; updatedAt: string })[],

  versions: [] as { id: string; resumeId: string; versionNumber: number; description: string; createdAt: string; snapshot: string }[],
};
