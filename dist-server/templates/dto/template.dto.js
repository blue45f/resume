...
_export(exports, {
    get CreateTemplateDto () {
        return CreateTemplateDto;
    },
    get LocalTransformDto () {
        return LocalTransformDto;
    },
    get UpdateTemplateDto () {
...
let UpdateTemplateDto = class UpdateTemplateDto {
};
_ts_decorate([
    (0, _swagger.ApiPropertyOptional)(),
    (0, _classvalidator.IsOptional)(),
...
let LocalTransformDto = class LocalTransformDto {
};
_ts_decorate([
    (0, _swagger.ApiPropertyOptional)({
...
_ts_decorate([
    (0, _swagger.ApiPropertyOptional)({
        description: '템플릿 ID (layout 설정 사용)'
    }),
    (0, _classvalidator.IsOptional)(),
    (0, _classvalidator.IsString)(),
    _ts_metadata("design:type", String)
