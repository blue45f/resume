...
describe('CommunityService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(_communityservice.CommunityService);
        jest.clearAllMocks();
    });
    describe('getPosts', ()=>{
        it('기본 조회 (최신순)', async ()=>{
        ...
        it('카테고리 필터', async ()=>{
            ...
            expect(mockPrisma.communityPost.findMany).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('toggleLike', ()=>{
        ...
        it('좋아요 취소', async ()=>{
            mockPrisma.communityLike.findUnique.mockResolvedValue({
                id: 'l1'
            });
