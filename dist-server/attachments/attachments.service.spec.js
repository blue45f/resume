...
describe('AttachmentsService', ()=>{
    ...
    describe('upload', ()=>{
        ...
        it('파일 크기 초과 → BadRequestException', async ()=>{
            ...
            await expect(service.upload('resume-1', file, 'document', '')).rejects.toThrow(_common.BadRequestException);
        });
        ...
        it('존재하지 않는 이력서 → NotFoundException', async ()=>{
            ...
            const file = createMockFile();
            await expect(service.upload('fake', file, 'document', '')).rejects.toThrow(_common.NotFoundException);
        });
