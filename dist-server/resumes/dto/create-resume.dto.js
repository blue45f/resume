...
exports.CreateResumeDto = exports.ActivityDto = exports.AwardDto = exports.LanguageDto = exports.CertificationDto = exports.ProjectDto = exports.SkillDto = exports.EducationDto = exports.ExperienceDto = exports.PersonalInfoDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '이력서 제목' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateResumeDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: PersonalInfoDto }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [ExperienceDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [SkillDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [ProjectDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [CertificationDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [LanguageDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [AwardDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => AwardDto),
    __metadata("design:type", Array)
], CreateResumeDto.prototype, "awards", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: [ActivityDto] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
