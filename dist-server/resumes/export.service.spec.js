...
describe('ExportService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(_exportservice.ExportService);
        jest.clearAllMocks();
    });
    describe('exportAsText', ()=>{
        ...
        it('존재하지 않는 이력서 → NotFoundException', async ()=>{
            ...
            await expect(service.exportAsText('fake')).rejects.toThrow(_common.NotFoundException);
        });
    });
    describe('exportAsMarkdown', ()=>{
        ...
        it('존재하지 않는 이력서 → NotFoundException', async ()=>{
            mockPrisma.resume.findUnique.mockResolvedValue(null);
            await expect(service.exportAsMarkdown('fake')).rejects.toThrow(_common.NotFoundException);
        });
    ...
    describe('exportAsJson', ()=>{
        ...
        it('존재하지 않는 이력서 → NotFoundException', async ()=>{
            mockPrisma.resume.findUnique.mockResolvedValue(null);
            await expect(service.exportAsJson('fake')).rejects.toThrow(_common.NotFoundException);
        });
    ...
    describe('exportAsDocx', ()=>{
        ...
        it('존재하지 않는 이력서 → NotFoundException', async ()=>{
            mockPrisma.resume.findUnique.mockResolvedValue(null);
            await expect(service.exportAsDocx('fake')).rejects.toThrow(_common.NotFoundException);
        });
