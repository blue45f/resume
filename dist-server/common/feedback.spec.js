...
describe('Feedback 시스템', () => {
    ...
    describe('피드백 생성', () => {
        ...
        it('모든 타입 생성 가능 (bug, feature, opinion, question)', () => {
            const types = ['bug', 'feature', 'opinion', 'question'];
    ...
    describe('정렬', () => {
        ...
        it('날짜 기준 최신순 정렬', () => {
            const items = [
                { ...createFeedbackItem('bug', '옛날', '내용', '유저'), createdAt: '2024-01-01T00:00:00.000Z' },
                { ...createFeedbackItem('feature', '최신', '내용', '유저'), createdAt: '2024-06-01T00:00:00.000Z' },
                { ...createFeedbackItem('opinion', '중간', '내용', '유저'), createdAt: '2024-03-15T00:00:00.000Z' },
            ];
